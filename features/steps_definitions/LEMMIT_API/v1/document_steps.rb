Dado('ter uma massa configurada do endpoint LEMMIT_API_v1_document.get para o cenário {tipo}') do |tipo|
  ...
  @LEMMIT_API_v1_document_get = endpoint
end

Quando('chamar o endpoint LEMMIT_API_v1_document.get') do
  @LEMMIT_API_v1_document_get.response = LEMMIT_API_v1_document().get_document(@LEMMIT_API_v1_document_get)
rescue StandardError => error
  @LEMMIT_API_v1_document_get.error = error
ensure
  puts(@LEMMIT_API_v1_document_get.request_log, @LEMMIT_API_v1_document_get.response_log)
end

Então('validar o retorno do endpoint LEMMIT_API_v1_document.get para o cenário {tipo}') do |tipo|
  aggregate_failures do
    endpoint = @LEMMIT_API_v1_document_get
